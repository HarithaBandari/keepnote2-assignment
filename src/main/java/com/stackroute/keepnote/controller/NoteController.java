...
public class NoteController {
	...
	public String add(@RequestParam("noteTitle") String noteTitle, @RequestParam("noteContent") String noteContent,
	...
	public String update(ModelMap map, @RequestParam("noteId") int noteId, @RequestParam("noteTitle") String noteTitle,
		...
		map.addAttribute("list", noteDao.getAllNotes());
		return "redirect:/";
